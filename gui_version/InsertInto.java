...
public class InsertInto {
    ...
    public void insertInto() {
        try (Connection conn = DriverManager.getConnection(CONNECTION); // Establish the database connection
            ...
            // Insert data into the table "FITNESSTRACKERDATASET"
            ...
            JOptionPane.showMessageDialog(null, "Rows added successfully!", "Insert Successful", JOptionPane.INFORMATION_MESSAGE);

        } catch (SQLException e) {
            // Show error message in GUI
            JOptionPane.showMessageDialog(null, "Error inserting rows:\n" + e.getMessage(),
